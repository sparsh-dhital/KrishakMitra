...
export default function FarmerPage({
  ...
  const [booking, setBooking] = useState(() => {
    try {
      const saved = localStorage.getItem(
        `krishak-mitra-booking:${farmerId || "anonymous"}`,
      );
  ...
  useEffect(() => {
    ...
    let active = true;
    api
      .getSlots(selectedCentre, new Date().toISOString().split("T")[0])
      .then((slotData) => {
        if (!active) return;
  ...
  async function createBooking() {
    ...
    try {
      ...
      localStorage.setItem(
        `krishak-mitra-booking:${farmerId}`,
          ...
          <div className="min-w-0 space-y-6 lg:col-span-2">
            ...
            <div className="bg-surface border border-line rounded-3xl p-4 sm:p-6 flex flex-col gap-6 shadow-sm sm:flex-row">
                    ...
                    <div className="flex items-center gap-4 mb-6">
                      <div className="p-3 bg-white rounded-xl shadow-sm border border-line">
                        {booking?.token?.token_number && (
                          <QRCode
                            value={booking.token.token_number}
                            size={64}
                          />
                        )}
                      </div>
              ...
              <div className="min-w-0 flex-1 border-t border-line pt-6 flex flex-col items-center justify-center sm:border-l sm:border-t-0 sm:pl-6 sm:pt-0">
                <h3 className="text-xs font-bold text-muted uppercase tracking-widest mb-4 self-start">
                  {t("capacityUsed")}
                </h3>
          ...
          {centres.map((c) => (
            ...
            >
              <div className="flex min-w-0 items-center gap-4">
                ...
                <div className="min-w-0">
                  <p className="wrap-break-word font-bold text-forest">
                    {c.name}
                  </p>
                  <p className="wrap-break-word text-xs text-muted font-medium mt-1">
        ...
        >
          {booking && !showNewBookingForm ? (
            ...
            <Card className="min-w-0 overflow-hidden p-0 shadow-lg">
              ...
              <div className="p-4 sm:p-8 min-h-75">
            ...
            <div className="relative overflow-hidden bg-white rounded-3xl border border-line shadow-2xl drop-shadow-xl">
              ...
              <div className="p-8 flex flex-col items-center text-center">
                ...
                <div>
                  ...
                  <p className="font-display text-5xl font-extrabold text-forest tracking-tight">
                    #{booking.token.token_number}
                  </p>
                </div>
          ...
          {booking?.booking ? (
            <Card>
              <div className="space-y-6">
                ...
                {booking.booking.status === "PAYMENT_REQUESTED" && (
                  <div className="pt-4 border-t border-amber-100 text-center text-sm font-medium text-amber-600 bg-amber-50 p-4 rounded-xl">
